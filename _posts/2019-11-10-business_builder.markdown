...
<code>rails g model title:string</code>
<br>
<br>

<li> Create a Message model</li>

<code>rails g model message content:string user_id:integer chat_room_id:integer   attachment_data:text file_name:string</code>
...
<li>Add the following code in your app/javascripts/chat_rooms.js</li>
<pre>
<code>
